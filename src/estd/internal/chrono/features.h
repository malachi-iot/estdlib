...
#if (defined(FEATURE_POSIX_CHRONO) || defined(ESTD_SDK_IDF) || defined(LIB_PICO_STDLIB) || FEATURE_STD_CHRONO) && !defined(FEATURE_ESTD_NATIVE_CHRONO) && __cplusplus >= 201103L
