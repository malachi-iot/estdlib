...
//template<>
streamsize native_streambuf<char, TEST_STREAM_T, ::std::char_traits<char> >::
...
//template<>
int native_streambuf<char, TEST_STREAM_T, ::std::char_traits<char> >::sputc(char ch)
{
...
//template<>
int native_streambuf<char, TEST_STREAM_T, ::std::char_traits<char> >::sbumpc()
{
    return fgetc(&this->stream);
}

//template<>
int native_streambuf<char, TEST_STREAM_T, ::std::char_traits<char> >::sgetc()
{
