...
* units system:
    ...
    * BREAKING CHANGE: stricter constructor rules and unit_cast to counterbalance it
...
* https://github.com/malachi-iot/estdlib/issues/177 chrono::duration (for some time now) has too permissive of a constructor
